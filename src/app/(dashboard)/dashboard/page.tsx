...
export default async function DashboardPage() {
  ...
  const quickModes = QUICK_MODES.filter((mode) => FEATURES[mode.feature]);
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="mt-4 max-w-xl text-base sm:text-lg font-semibold text-foreground/75">
            {FEATURES.testPackage
              ...
              : FEATURES.flashcard
                ? "Tuntaskan antrean flashcard dan lanjutkan modul belajarmu dari sini."
                : "Lanjutkan modul belajarmu dari sini."}
          </p>

          {(FEATURES.testPackage || FEATURES.history) && (
