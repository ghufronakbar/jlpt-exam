...
export default function AuthLayout({
  ...
  return (
    <TurnstileProvider siteKey={env.CLOUDFLARE_TURNSTILE_SITEKEY}>
      <div className="neo-grid-paper min-h-[100dvh] flex-1 p-4 sm:p-6">
        ...
        <div className="mx-auto grid min-h-[calc(100dvh-2rem)] max-w-7xl overflow-hidden border-[3px] border-neo-ink bg-white shadow-neo-lg sm:min-h-[calc(100dvh-3rem)] lg:grid-cols-[0.9fr_1.1fr]">
              ...
              <div className="mt-10 grid gap-3">
                {[
                  ...
                  return (
                    <div
                      key={label as string}
                      className="flex items-center gap-3 border-[3px] border-neo-ink bg-white px-4 py-3 font-bold shadow-neo-sm"
                    >
          ...
          <main
            id="auth-content"
            className="flex items-center justify-center bg-background p-5 sm:p-10"
          >
